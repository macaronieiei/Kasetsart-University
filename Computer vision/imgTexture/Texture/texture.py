...
print("Fedgeness1 : ", calFEdgeness(red_apple_texture_gray, 100))

# Create texture histogram consisting of normalized mean gray value and Fedgeness
def calTextureHis(img):
    texture_histogram = np.array([calMeanGray(img), calFEdgeness(img, 200)])
...
# Test red_apple1
result = textureOverlay(red_apple1, red_apple_texture_gray, 0.2)
cv2.imshow('red_apple1_0.2', result)
result = textureOverlay(red_apple1, red_apple_texture_gray, 0.3)
cv2.imshow('red_apple1_0.3', result)
result = textureOverlay(red_apple1, red_apple_texture_gray, 0.4)
cv2.imshow('red_apple1_0.4', result)

# Test red_apple2
result = textureOverlay(red_apple2, red_apple_texture_gray, 0.2)
cv2.imshow('red_apple2_0.2', result)
result = textureOverlay(red_apple2, red_apple_texture_gray, 0.3)
cv2.imshow('red_apple2_0.3', result)
result = textureOverlay(red_apple2, red_apple_texture_gray, 0.4)
cv2.imshow('red_apple2_0.4', result)

# Test red_apple3
result = textureOverlay(red_apple3, red_apple_texture_gray, 0.2)
cv2.imshow('red_apple3_0.2', result)
result = textureOverlay(red_apple3, red_apple_texture_gray, 0.3)
cv2.imshow('red_apple3_0.3', result)
result = textureOverlay(red_apple3, red_apple_texture_gray, 0.4)
cv2.imshow('red_apple3_0.4', result)

# Test red_apple4
result = textureOverlay(red_apple4, red_apple_texture_gray, 0.2)
cv2.imshow('red_apple4_0.2', result)
result = textureOverlay(red_apple4, red_apple_texture_gray, 0.3)
cv2.imshow('red_apple4_0.3', result)
result = textureOverlay(red_apple4, red_apple_texture_gray, 0.4)
cv2.imshow('red_apple4_0.4', result)
