...
red_apple_texture = cv2.imread(r"D:\b6621604700\texture\red_apple_texture.jpg")
...
def calTextureHis(img):
    texture_histogram = np.array([calMeanGray(img), calFEdgeness(img, 100)])
...
red_apple1 = cv2.imread(r"D:\b6621604700\texture\red_apple1.png", cv2.IMREAD_GRAYSCALE)
red_apple2 = cv2.imread(r"D:\b6621604700\texture\red_apple2.png", cv2.IMREAD_GRAYSCALE)
red_apple3 = cv2.imread(r"D:\b6621604700\texture\red_apple3.jpg", cv2.IMREAD_GRAYSCALE)
red_apple4 = cv2.imread(r"D:\b6621604700\texture\red_apple4.jpg", cv2.IMREAD_GRAYSCALE)
