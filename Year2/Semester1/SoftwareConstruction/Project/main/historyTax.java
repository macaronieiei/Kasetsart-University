...
public class historyTax extends JPanel {
    ...
    private void initializeUI() {
        ...
        taxDataAreaBackground.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.BLACK), "ข้อมูลภาษี",javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP,new Font("Tahoma", Font.BOLD, 18), Color.BLACK));
